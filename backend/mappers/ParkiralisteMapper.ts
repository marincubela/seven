...
export class ParkiralisteMapper extends Mapper {
  public static toDomain(parkiralisteDTO: ParkiralisteDTO): IParkiralisteAttributes {
    return {
  ...
  public static async toDTO(parkiraliste: Parkiraliste): Promise<ParkiralisteDTO> {
