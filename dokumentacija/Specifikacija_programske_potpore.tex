...
\begin{figure}[H]
	\includegraphics[width=1\linewidth]{slike/Korisnički podaci.PNG} %veličina u odnosu na širinu linije
	\caption{Prikaz funkcionalnosti vezanih za korisničke podatke}
	\label{fig:promjene2} %label mora biti drugaciji za svaku sliku
\end{figure}
\begin{figure}[H]
	\includegraphics[width=1\linewidth]{slike/Pregled ostalih funkcionalnosti.PNG} %veličina u odnosu na širinu linije
