...
\noindent \underbar{\textbf{UC\showuccounter\ - Neovlašteni pristup privatnim rutama}}
\begin{packed_item}
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Prikažu se podataka o vozilu
...
\begin{packed_item}
	...
	\item[] \begin{packed_item}
		...
		\item[] \begin{packed_enum}
			...
			\item Klijent se prikazuje poruka o nevažećim podacima
			\item Klijent ispravlja podatke
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Korisnik otvara podatke o korisničkom računu
		\item Prikažu se podatci o korisničkom računu
		\item Korisnik odabire gumb "Dodaj karticu"
		\item Prikaže se forma za dodavanje podataka o kartici
		\item Korisnik upisuje podatke i prikazuje mu se poruka da je kartica uspješno dodana
		\item Korisnik je preusmjeren nazad na podatke o korisničkom računu
	...
	\item[] \begin{packed_item}
		...
		\item[6.a] Nevažeći podatci prilikom dodavanja kartice
		\item[] \begin{packed_enum}
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Korisnik otvara podatke o korisničkom računu
		\item Prikažu se podatci o korisničkom računu
		\item Korisnik odabire na karticu čije podatke želi pregledati
		\item Prikažu se podatci o kartici
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Korisnik otvara podatke o korisničkom računu
		\item Prikažu se podatci o korisničkom računu
		\item Korisnik odabire na karticu čije podatke želi urediti
		\item Prikažu se podatci o kartici
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Korisnik otvara podatke o korisničkom računu
		\item Prikažu se podatci o korisničkom računu
		\item Korisnik odabire na karticu čije podatke želi obrisati
		\item Prikažu se podatci o kartici
		\item Korisnik odabire akciju uklanjanja kartice
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Korisnik na mapi odabire željeno parkiralište
		\item Prikažu se podatci o parkiralištu
		\item Korisnik odabire opciju rezervacije parkirnog mjesta
		\item Korisnika se preusmjerava na plaćanje
		\item Korisnik unosi podatke o plaćanju
		\item Korisnika se preusmjerava na kartu s uputama do parkirališta za koje je platio rezervaciju
	...
	\item[] \begin{packed_item}
		...
		\item[] \begin{packed_enum}
			...
			\item Korisnika se obavještava porukom o zauzetosti parkinga
			\item Korisniku se osvježe stanja parkinga
			\item Korisnika se vraća na kartu s parkiralištima
		...
		\item[] \begin{packed_enum}
			...
			\item Korisnika se obavještava porukom o neuspjelom plaćanju
			\item Korisniku se ponovno pokazuje forma za plaćanje
			\item Korisnik unosi nove podatke ili odabire drugu karticu
...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item Korisnik na mapi odabire željeno parkiralište
		\item Prikažu se podatci o parkiralištu
		\item Korisnik odabire "Upute"
		\item Otvara se google maps navigacija
		
	\end{packed_enum}
\end{packed_item}

\noindent \underbar{\textbf{UC\showuccounter - Upute do sparkiranog automobila}}
\begin{packed_item}
	
	\item \textbf{Glavni sudionik:} Klijent
	\item  \textbf{Cilj:} Navođenje do parkirališta na kojem je korisnikov automobil
	\item  \textbf{Sudionici:} Baza podataka
	...
	\item[] \begin{packed_enum}
		...
		\item Klijent na početnom zaslonu aplikacije odabire opciju "Upute do automobila"
		\item Otvara se google maps navigacija
