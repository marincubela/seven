...
\noindent \underbar{\textbf{UC\showuccounter - Uređivanje podataka o rezervaciji}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC\showuccounter - Uklanjanje rezervacije}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC\showuccounter\ - Dodavanje administratorskog prava}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC\showuccounter\ - Uklanjanje administratorskog prava}}
\begin{packed_item}
...
\begin{figure}[H]
	\includegraphics[width=1\linewidth]{dijagrami/UC_Korisnicki podatci.png} %veličina u odnosu na širinu linije
	\caption{Prikaz funkcionalnosti vezanih za korisničke podatke}
	\label{fig:promjene2} %label mora biti drugaciji za svaku sliku
\end{figure}
\begin{figure}[H]
	\includegraphics[width=1\linewidth]{dijagrami/UC_Pregled ostalih funkcionalnosti.png} %veličina u odnosu na širinu linije
